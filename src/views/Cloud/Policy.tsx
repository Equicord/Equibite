                    ...
                    <div class="space-y-4">
                        <div class="bg-neutral-900/50 border border-neutral-700 rounded-lg p-4">
                            ...
                            <p class="text-sm font-medium text-neutral-400">
                                We store the SHA-256 hash of your Discord user ID to
                        ...
                        <div class="bg-neutral-900/50 border border-neutral-700 rounded-lg p-4">
                            ...
                            <p class="text-sm font-medium text-neutral-400">
                                Your Equicord settings are securely stored on our servers,
                                tied to only your generated hash and able to synchronized
                                across devices.
                            </p>
                        </div>
                    </div>
