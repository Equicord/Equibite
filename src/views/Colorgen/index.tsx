...
export default function EquicordColors() {
            ...
            while (itemCount < totalItems) {
                ...
                while (batchCount < batchSize && itemCount < totalItems) {
                    const rIndex = Math.floor(
                        itemCount / (maxStepCount * maxStepCount),
                    )
    ...
    createEffect(() => {
        ...
        sorted.sort((a, b) => {
            switch (sortVal) {
                case 'brightness':
                    return (
                        getBrightness(b.r, b.g, b.b) -
                        getBrightness(a.r, a.g, a.b)
                    )
                case 'luminance':
                    return (
                        getLuminance(b.r, b.g, b.b) -
                        getLuminance(a.r, a.g, a.b)
                    )
                case 'hue':
                    return getHue(a.r, a.g, a.b) - getHue(b.r, b.g, b.b)
                case 'saturation':
                    return (
                        getSaturation(b.r, b.g, b.b) -
                        getSaturation(a.r, a.g, a.b)
                    )
                case 'red':
                    return b.r - a.r
                case 'green':
    ...
    const onSortChange = (e: { target: { value: any } }) =>
