            ...
            <div class="mt-20 flex flex-col md:flex-row md:justify-between gap-6 md:gap-3 px-4 md:px-0">
                ...
                <div class="flex flex-col gap-3 items-center md:items-start">
                    ...
                    <div class="flex gap-6 md:gap-4">
                        <a href="https://github.com/Equicord/Equicord" class="text-sm text-neutral-400">GitHub</a>
                        <a href="https://discord.gg/gQ79NCNKuM" class="text-sm text-neutral-400">Discord</a>
                    </div>
                </div>
        </div>
    )
