...
import { Download, Image as ImageIcon, Loader2, Search } from "lucide-solid";
			...
			<div class="flex flex-col gap-8">
				...
				<Show when={loading()}>
					<div class="flex flex-col items-center justify-center py-20 gap-4">
						<Loader2 class="animate-spin text-neutral-400" size={40} />
						<p class="text-neutral-400">Loading icons...</p>
					</div>
				</Show>

				<Show when={!loading() && filteredFolders().length === 0}>
					<div class="flex flex-col items-center justify-center py-20 gap-4">
								...
								<div class="flex flex-col gap-6">
									<div class="flex items-center gap-3">
										<h2 class="text-2xl font-bold">
											{folder === "" ? "General" : formatFolderName(folder)}
										</h2>
